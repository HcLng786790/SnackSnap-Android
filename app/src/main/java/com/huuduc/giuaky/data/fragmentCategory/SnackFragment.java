...
//    private DSProduct product;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_snack, container, false);

        recyclerView = mView.findViewById(R.id.rcv_snack);
...
//        productAdapter.setData(product.getListByType(3,product.getProducts()));
//
//        recyclerView.setAdapter(productAdapter);
    ...
    private void loadProductSnack() {
        RetrofitService retrofitService = new RetrofitService();
        ProductApi productApi = retrofitService.getRetrofit().create(ProductApi.class);
        productApi.getAllByType(3)
