...
//            public void onClick(View v) {
//
//                //Lấy số lượng ở phần chi tiết sản phẩm
//                int soluong = Integer.parseInt(txtNumberOrders.getText().toString());
//
//                //Check xem mảng giỏ hàng có dữ liệu không
//                if(MainActivity.cartList.size()>0){
//
//                    boolean exit = false;
//
//                    //duyệt mảng giỏ hàng nếu đã có sản phẩm đó ròi thì update sl và giá
//                    for (int i =0; i<MainActivity.cartList.size() ; i++){
//                        if(Objects.equals(MainActivity.cartList.get(i).getNameSP(), thisProduct.getName())){
//
//                            updateCart(MainActivity.cartList.get(i),soluong,thisProduct.getPrice());
////                            MainActivity.cartList.get(i).setSoluongSP(MainActivity.cartList.get(i).getSoluongSP() + soluong);
////                            MainActivity.cartList.get(i).setPriceSP(thisProduct.getPrice()*MainActivity.cartList.get(i).getSoluongSP());
//                            exit=true;
//                        }
//                    }
//
//                    //nếu chưa có sản phẩm đó thì thêm mới vào giỏ hàng
//                    if (exit == false) {
//
//                        createNewCart(soluong,thisProduct, MainActivity.cartList);
////                        long newPrice = (long) (soluong * thisProduct.getPrice());
////                        MainActivity.cartList.add(
////                                new Cart(
////                                        thisProduct.getName(),
////                                        newPrice,
////                                        thisProduct.getImg(),
...
//                    }
//
//                //Nếu mảng giỏ hàng rỗng thì tiến hành thêm mới
//                }else{
//                    createNewCart(soluong,thisProduct, MainActivity.cartList);
//
////                    long newPrice = (long) (soluong * thisProduct.getPrice());
...
//        });
    ...
    private void addToCart() {
        ...
        cartApi.addToCart(1, cartDetailsDTO)
